...
const Footer = () => {
  ...
  return (
    <footer className="relative p-8">
      ...
      <div className="mt-32 flex justify-between items-center gap-6">
        <div className="h-[2px] w-full bg-black rounded-full" />
        <p className="font-satoshi font-light text-base max-lg:text-lg max-2xl:text-xl 2xl:text-2xl min-w-fit">
